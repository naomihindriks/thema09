...
```{r abbreviations}
abbreviations <- data.frame(abbreviations = c("FNA"), full.name = c("Fine needle aspiration"))
...
```{r print-distribution-barplot, fig.height=10, fig.width=8, fig.cap="Distribution of data in percentage for 9 different cytological characteristics for benign instances, malignant instances and for all instances together",fig.pos="H"}
