...
by_run <- weka.experiment %>%
  group_by(Key_Run, Algorithm, Cost) %>%
  summarise(
...
weka.experiment <- read.arff("data/weka_experiment_naive_bayes_attributeSelect.arff.arff")
...
Now I will try to see if I can get a better performing algorithm by combining different algorithms. I have chosen to use the IBk (KNN = 2), Naive Bayes (useSupervisedDiscretization = True) and the Random Forest Algorithm for this.
